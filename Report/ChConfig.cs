...
namespace Reports {
    ...
    public class ChConfig : ReportClass {
    ...
    public class CachedChConfig : Component, ICachedReport {
        
        public CachedChConfig() {
        }
