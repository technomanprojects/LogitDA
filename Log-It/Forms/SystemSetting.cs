    ...
    public partial class SystemSetting : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                testCMD = new SqlCommand("CREATE TABLE [dbo].[User]([Id] [int] IDENTITY(1,1) NOT NULL,[User_Name] [nvarchar](50) NOT NULL,[Password] [nvarchar](2000) NULL,[Role] [int] NULL,[CreatedBy] [nvarchar](50) NULL,[CreateDateTime] [datetime] NULL,[Active] [bit] NULL,[ModefiedBy] [nvarchar](50) NULL,[ModifiedDateTime] [datetime] NULL,[IsRowEnable] [bit] NULL,[Full_Name] [nvarchar](max) NULL,[Authority] [nvarchar](50) NULL,[Department] [nvarchar](max) NULL,[Title] [nvarchar](200) NULL,[Email] [nvarchar](50) NULL,[Phone] [nvarchar](50) NULL,[Signature] [nvarchar](50) NULL,[Password_expiry_date] [datetime] NULL,[Password_Expiry] [int] NULL,[email_notification] [bit] NULL,[sms_notification] [bit] NULL,CONSTRAINT [PK_User_1] PRIMARY KEY CLUSTERED ([Id] ASC)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]) ON [PRIMARY]", Conn);
                testCMD.CommandType = CommandType.Text;
                Conn.Open();
                i = testCMD.ExecuteNonQuery();
                ...
                testCMD = new SqlCommand("INSERT INTO [User] ([User_Name],[Password],[Role],[CreatedBy],[CreateDateTime],[Active],[ModefiedBy],[ModifiedDateTime],[IsRowEnable],[Full_Name],[Authority],[Email]) VALUES ('" +
                    textBoxuserName.Text + "','" + BAL.Authentication.GetEc(textBoxloginpassword.Text) + "','" + 0 + "','System Admin',GETDATE(),1,'NULL',NULL," + 1 + ",'System Administrator','Owner','NULL')", Conn);
                testCMD.CommandType = CommandType.Text;
                Conn.Open();
                i = testCMD.ExecuteNonQuery();
                Conn.Close();
